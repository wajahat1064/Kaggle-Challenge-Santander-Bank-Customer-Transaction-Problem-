...
In the jupyter notebook file, we will be **exploring the data**, **preparing it for a LightGBM model**, **training the LightGBM model** and **predicting the target value for the test set**.
